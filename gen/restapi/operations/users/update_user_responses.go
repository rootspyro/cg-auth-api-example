...
/*
UpdateUserDefault generic error response
...
func (o *UpdateUserDefault) WithPayload(payload *models.Default) *UpdateUserDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update user default response
func (o *UpdateUserDefault) SetPayload(payload *models.Default) {
	o.Payload = payload
}
