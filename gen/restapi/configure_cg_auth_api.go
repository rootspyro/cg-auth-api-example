...
//go:generate swagger generate server --target ../../gen --name CgAuthAPI --spec ../../swagger/swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.CgAuthAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CgAuthAPIAPI) http.Handler {
	...
	if api.UsersGetUserByUsernameHandler == nil {
		api.UsersGetUserByUsernameHandler = users.GetUserByUsernameHandlerFunc(func(params users.GetUserByUsernameParams) middleware.Responder {
			return middleware.NotImplemented("operation users.GetUserByUsername has not yet been implemented")
		})
	}
